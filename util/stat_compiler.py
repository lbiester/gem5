...
def make_stat_hist(name, value_name, stat_for_benchmarks):
    ...
    plt.savefig('util/plots/{}.png'.format(name))
    plt.clf()
...
def main():
    ...
    make_stat_hist("IPC", "instructions per cycle", ipc)
    make_stat_hist("L1 CMPK", "misses per kilo-instruction", l1_miss)
    make_stat_hist("L2 CMPK", "misses per kilo-instruction", l2_miss)
